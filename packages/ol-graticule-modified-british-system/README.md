...
> His decades of meticulous research into the Modified British System —
...
- **Letter-cell codes** centred in each cell — `vK`, `wL`, `aT`, etc. —
  fading in / out with zoom so they appear only when readable.
...
translator. Decades of patient archival research that nobody else has
done in one place. If you use this package professionally, send him a
note — and read his pages.
